...
public class DefaultTradeService implements TradeService {
	...
	public DefaultTradeService(CryptoService service, TradeRepository jdbcRepository,
	...
	Mono<Void> resilientlyStoreByBatchesToAllRepositories(Flux<Trade> input, TradeRepository tradeRepository1,
			TradeRepository tradeRepository2) {
		Sinks.Many<Long> delayNotifier = Sinks.unsafe()
						.many()
						.multicast()
						.onBackpressureBuffer(1, false);
		Sinks.Many<Long> intervalNotifier = Sinks.unsafe()
						.many()
						.multicast()
						.onBackpressureBuffer(1, false);
